...
export default function VisitorAnalytics() {
  ...
  const fetchVisitorData = async (days) => {
    ...
    setError(null);
    try {
      console.log('Fetching visitor data for', days, 'days');
    ...
    return (
      ...
      >
        <div className="text-center py-8">
          ...
          <p className="text-gray-400 text-sm mb-4">Unable to load visitor analytics</p>
  ...
  // Fallback data if no visitor data
  if (!visitorData) {
    return (
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="text-center py-8">
          ...
          <p className="text-gray-400 text-sm">Visitor analytics will appear here once data is available</p>
        </div>
      </motion.div>
    );
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div className="flex items-center space-x-3 mb-4 sm:mb-0">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Track your platform engagement</p>
          </div>
        </div>
